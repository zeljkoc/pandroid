...
PROJECT=/usr/local/pandroid/example/ListViewObject
...
$PANDROID/pandroid R ListViewObject zeljus.com.listviewobject $PROJECT/android/gen/zeljus/com/listviewobject/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/ListViewObject.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/ListViewObject.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/ListViewObject.apk


adb unistall zeljus.com.listviewobject
adb install -r $PROJECT/ListViewObject.apk

adb shell am start -n zeljus.com.listviewobject/zeljus.com.listviewobject.MainActivity
