...
type
  CLAHAsyncHttpClient = class;
  Arr1CLAHAsyncHttpClient = array of CLAHAsyncHttpClient;
  Arr2CLAHAsyncHttpClient = array of Arr1CLAHAsyncHttpClient;
  Arr3CLAHAsyncHttpClient = array of Arr2CLAHAsyncHttpClient;

  CLAHBinaryHttpResponseHandler = class;
  Arr1CLAHBinaryHttpResponseHandler = array of CLAHBinaryHttpResponseHandler;
  Arr2CLAHBinaryHttpResponseHandler = array of Arr1CLAHBinaryHttpResponseHandler;
  Arr3CLAHBinaryHttpResponseHandler = array of Arr2CLAHBinaryHttpResponseHandler;

  CLAHRetryHandler = class;
  Arr1CLAHRetryHandler = array of CLAHRetryHandler;
  Arr2CLAHRetryHandler = array of Arr1CLAHRetryHandler;
  Arr3CLAHRetryHandler = array of Arr2CLAHRetryHandler;

  CLAHSimpleMultipartEntity = class;
  Arr1CLAHSimpleMultipartEntity = array of CLAHSimpleMultipartEntity;
  Arr2CLAHSimpleMultipartEntity = array of Arr1CLAHSimpleMultipartEntity;
  Arr3CLAHSimpleMultipartEntity = array of Arr2CLAHSimpleMultipartEntity;

  CLAHSyncHttpClient = class;
  Arr1CLAHSyncHttpClient = array of CLAHSyncHttpClient;
  Arr2CLAHSyncHttpClient = array of Arr1CLAHSyncHttpClient;
  Arr3CLAHSyncHttpClient = array of Arr2CLAHSyncHttpClient;

  CLAHSerializableCookie = class;
  Arr1CLAHSerializableCookie = array of CLAHSerializableCookie;
  Arr2CLAHSerializableCookie = array of Arr1CLAHSerializableCookie;
  Arr3CLAHSerializableCookie = array of Arr2CLAHSerializableCookie;

  CLAHRequestParams = class;
  Arr1CLAHRequestParams = array of CLAHRequestParams;
  Arr2CLAHRequestParams = array of Arr1CLAHRequestParams;
  Arr3CLAHRequestParams = array of Arr2CLAHRequestParams;

  CLAHJsonHttpResponseHandler = class;
  Arr1CLAHJsonHttpResponseHandler = array of CLAHJsonHttpResponseHandler;
  Arr2CLAHJsonHttpResponseHandler = array of Arr1CLAHJsonHttpResponseHandler;
  Arr3CLAHJsonHttpResponseHandler = array of Arr2CLAHJsonHttpResponseHandler;

  CLAHAsyncHttpResponseHandler = class;
  Arr1CLAHAsyncHttpResponseHandler = array of CLAHAsyncHttpResponseHandler;
  Arr2CLAHAsyncHttpResponseHandler = array of Arr1CLAHAsyncHttpResponseHandler;
  Arr3CLAHAsyncHttpResponseHandler = array of Arr2CLAHAsyncHttpResponseHandler;

  CLAHPersistentCookieStore = class;
  Arr1CLAHPersistentCookieStore = array of CLAHPersistentCookieStore;
  Arr2CLAHPersistentCookieStore = array of Arr1CLAHPersistentCookieStore;
  Arr3CLAHPersistentCookieStore = array of Arr2CLAHPersistentCookieStore;

  CLAHAsyncHttpRequest = class;
  Arr1CLAHAsyncHttpRequest = array of CLAHAsyncHttpRequest;
  Arr2CLAHAsyncHttpRequest = array of Arr1CLAHAsyncHttpRequest;
  Arr3CLAHAsyncHttpRequest = array of Arr2CLAHAsyncHttpRequest;
  ...
  OAHICAbstractHttpClient = class external 'org.apache.http.impl.client' name 'AbstractHttpClient';
  ...
  JUCThreadPoolExecutor = class external 'java.util.concurrent' name 'ThreadPoolExecutor';
  ...
  OJJSONArray = class external 'org.json' name 'JSONArray';
  ...
  AOMessage = class external 'android.os' name 'Message';
  ...
  OAHICDefaultHttpClient = class external 'org.apache.http.impl.client' name 'DefaultHttpClient';
  ...
  JUHashSet = class external 'java.util' name 'HashSet';
  Arr1JUHashSet = array of JUHashSet;
  Arr2JUHashSet = array of Arr1JUHashSet;
  Arr3JUHashSet = array of Arr2JUHashSet;

  OAHCSSSLSocketFactory = class external 'org.apache.http.conn.ssl' name 'SSLSocketFactory';
  ...
  JUCConcurrentHashMap = class external 'java.util.concurrent' name 'ConcurrentHashMap';
  ...
  OAHAAuthScope = class external 'org.apache.http.auth' name 'AuthScope';
  ...
  OJJSONObject = class external 'org.json' name 'JSONObject';
  ...
  OAHCMHttpUriRequest = interface external 'org.apache.http.client.methods' name 'HttpUriRequest';
