...
PROJECT=/usr/local/pandroid/example/DemoOpenGL
...
$PANDROID/pandroid R DemoOpeGL zeljus.com.demoopengl $PROJECT/android/gen/zeljus/com/demoopengl/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/DemoOpeGL.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/DemoOpeGL.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/DemoOpeGL.apk


adb unistall zeljus.com.demoopengl
adb install -r $PROJECT/DemoOpeGL.apk

adb shell am start -n zeljus.com.demoopengl/zeljus.com.demoopengl.MainActivity
