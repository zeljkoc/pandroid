...
PROJECT=/usr/local/pandroid/example/Vibrator
...
$PANDROID/pandroid R Vibrator zeljus.com.vibrator $PROJECT/android/gen/zeljus/com/vibrator/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/Vibrator.lpr
...
jarsigner -verify -verbose -certs $PROJECT/Vibrator.apk


adb unistall zeljus.com.vibrator
adb install -r $PROJECT/Vibrator.apk

adb shell am start -n zeljus.com.vibrator/zeljus.com.vibrator.MainActivity
