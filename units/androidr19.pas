...
type
  ...
  AHLGeofenceHardware = class;
  Arr1AHLGeofenceHardware = array of AHLGeofenceHardware;
  Arr2AHLGeofenceHardware = array of Arr1AHLGeofenceHardware;
  Arr3AHLGeofenceHardware = array of Arr2AHLGeofenceHardware;

  AHLGeofenceHardwareCallback = class;
  Arr1AHLGeofenceHardwareCallback = array of AHLGeofenceHardwareCallback;
  Arr2AHLGeofenceHardwareCallback = array of Arr1AHLGeofenceHardwareCallback;
  Arr3AHLGeofenceHardwareCallback = array of Arr2AHLGeofenceHardwareCallback;

  AHLGeofenceHardwareMonitorCallback = class;
  Arr1AHLGeofenceHardwareMonitorCallback = array of AHLGeofenceHardwareMonitorCallback;
  Arr2AHLGeofenceHardwareMonitorCallback = array of Arr1AHLGeofenceHardwareMonitorCallback;
  Arr3AHLGeofenceHardwareMonitorCallback = array of Arr2AHLGeofenceHardwareMonitorCallback;

  AHLGeofenceHardwareRequest = class;
  Arr1AHLGeofenceHardwareRequest = array of AHLGeofenceHardwareRequest;
  Arr2AHLGeofenceHardwareRequest = array of Arr1AHLGeofenceHardwareRequest;
  Arr3AHLGeofenceHardwareRequest = array of Arr2AHLGeofenceHardwareRequest;
