...
PROJECT=/usr/local/pandroid/example/ScrollView
...
$PANDROID/pandroid R ScrollView zeljus.com.scrollview $PROJECT/android/gen/zeljus/com/scrollview/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/ScrollView.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/ScrollView.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/ScrollView.apk


adb shell pm uninstall -k zeljus.com.scrollview
adb install -r $PROJECT/ScrollView.apk

adb shell am start -n zeljus.com.scrollview/zeljus.com.scrollview.MainActivity
