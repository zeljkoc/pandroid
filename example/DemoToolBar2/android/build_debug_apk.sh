...
PROJECT=/usr/local/pandroid/example/DemoToolBar2
...
$PANDROID/pandroid R DemoToolBar2 zeljus.com.demotoolbar2 $PROJECT/android/gen/zeljus/com/demotoolbar2/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/DemoToolBar2.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/DemoToolBar2.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/DemoToolBar2.apk


adb shell pm uninstall -k zeljus.com.demotoolbar2
adb install -r $PROJECT/DemoToolBar2.apk

adb shell am start -n zeljus.com.demotoolbar2/zeljus.com.demotoolbar2.MainActivity
