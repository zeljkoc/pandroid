...
begin
  case TDialog(para1).ID of
    ...
    id_edit: if para2 = -1 then ShowMessage(getContext, JLString('Edit: ').concat(JLInteger.toString(FIDRecord)));
  end;
end;
...
procedure TDBGridViewLayout.CreateEditForms;
begin
