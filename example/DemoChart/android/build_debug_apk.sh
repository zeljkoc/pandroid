...
PROJECT=/usr/local/pandroid/example/DemoChart
...
$PANDROID/pandroid R DemoChart zeljus.com.demochart $PROJECT/android/gen/zeljus/com/demochart/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/DemoChart.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/DemoChart.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/DemoChart.apk


adb unistall zeljus.com.demochart
adb install -r $PROJECT/DemoChart.apk

adb shell am start -n zeljus.com.demochart/zeljus.com.demochart.MainActivity
