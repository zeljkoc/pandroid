  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          //You can't simply set GURL.URI becuase the URI has to be valid
          //and in this case, it may be empty if you wanted help using the
          //program.
            GURLStr := ParamStr(i);
        end;
      end;
    ...
    if (GURLStr = '') or GHelpScreen then
    begin
      GHelpScreen := True;
    end
    else
