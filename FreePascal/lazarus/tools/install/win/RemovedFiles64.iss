...
Name: {app}debugger\fpgdbmidebugger.pp; Type: files
Name: {app}debugger\gdbmidebugger.pp; Type: files
Name: {app}debugger\gdbmidebuginstructions.pp; Type: files
Name: {app}debugger\gdbmimiscclasses.pp; Type: files
Name: {app}debugger\gdbmiserverdebugger.pas; Type: files
Name: {app}debugger\gdbtypeinfo.pp; Type: files
Name: {app}debugger\sshgdbmidebugger.pas; Type: files
Name: {app}ide\ideminilibc.pas; Type: files
Name: {app}debugger\cmdlinedebugger.pp; Type: files
Name: {app}debugger\debugutils.pp; Type: files
; Files that are no longer present in Lazarus 1.2 (moved after 1.0)
Name: {app}lcl\utf8process.pp; Type: files
Name: {app}lcl\units\x86_64-win64\utf8process.o; Type: files
Name: {app}lcl\units\x86_64-win64\utf8process.ppu; Type: files
Name: {app}lcl\lazconfigstorage.pas; Type: files
Name: {app}lcl\units\x86_64-win64\lazconfigstorage.o; Type: files
Name: {app}lcl\units\x86_64-win64\lazconfigstorage.ppu; Type: files
...
Name: {app}components\synedit\units\x86_64-win64\synpropertyeditobjectlist.o; Type: files
Name: {app}components\synedit\units\x86_64-win64\synpropertyeditobjectlist.ppu; Type: files
Name: {app}units\x86_64-win64\win32\filesystem.o; Type: files
Name: {app}units\x86_64-win64\win32\filesystem.ppu; Type: files
Name: {app}units\x86_64-win64\win32\abstracteditor.o; Type: files
Name: {app}units\x86_64-win64\win32\abstracteditor.ppu; Type: files
