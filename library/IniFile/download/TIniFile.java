...
public class TIniFile
{
	...
	public TIniFile(String pFileName)
	{
		...
		if(file.exists())
		{
			...
			{
				System.out.println("Exception@TIniFile.constructor(): " + exception);
				System.out.println("Exception@TIniFile.constructor(): szFileName = " + szFileName);
			}
		}
	}
	...
	public double getDouble(String pSection, String pKey, double pDefaultValue)
	{
		...
		{
			System.out.println("Exception@TIniFile.getDouble(" + pSection + ", " + pKey + ", " + String.valueOf(pDefaultValue) + "): " + exception);
			return pDefaultValue;
		}
	}
	...
	public int getInt(String pSection, String pKey, int pDefaultValue)
	{
		...
		{
			System.out.println("Exception@TIniFile.getInt(" + pSection + ", " + pKey + ", " +  String.valueOf(pDefaultValue) + "): " + exception);
			return pDefaultValue;
		}
	}
	...
	public String getSection(String pKey, String pValue)
	{
		...
		{
			System.out.println("Exception@TIniFile.getSection(" + pKey + ", " + pValue + "): " + exception);
			return "";
		}
	}
	...
	private boolean saveFile()
	{
		...
		if(szFileName.lastIndexOf('/') >= 0)
		{
			...
			if(!fFolderFile.exists())
			{
				...
				{
					System.out.println("Can't create folders: " + szFolderPath);
					System.out.println("fFolderFile.mkdirs() = false!");
					return false;
				}
				else
				{
		...
		{
			System.out.println("Exception@TIniFile.saveFile(): " + exception);
			System.out.println("Exception@TIniFile.saveFile(): szFilename = " + szFileName);
			return false;
		}
	}
