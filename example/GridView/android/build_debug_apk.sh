...
PROJECT=/usr/local/pandroid/example/GridView
...
$PANDROID/pandroid R GridView zeljus.com.gridview $PROJECT/android/gen/zeljus/com/gridview/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/GridView.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/GridView.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/GridView.apk


adb shell pm uninstall -k zeljus.com.gridview
adb install -r $PROJECT/GridView.apk

adb shell am start -n zeljus.com.gridview/zeljus.com.gridview.MainActivity
