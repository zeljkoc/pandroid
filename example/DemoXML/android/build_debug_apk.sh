...
PROJECT=/usr/local/pandroid/example/DemoXML
...
$PANDROID/pandroid R DemoXML zeljus.com.demoxml $PROJECT/android/gen/zeljus/com/demoxml/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/DemoXML.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/DemoXML.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/DemoXML.apk


adb shell pm uninstall -k zeljus.com.demoxml
adb install -r $PROJECT/DemoXML.apk

adb shell am start -n zeljus.com.demoxml/zeljus.com.demoxml.MainActivity
