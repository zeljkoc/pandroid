...
$PANDROID/pandroid R DateTime zeljus.com.datetime $PROJECT/android/gen/zeljus/com/datetime/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc32/bin/i386-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/DateTime.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/DateTime.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/DateTime.apk


adb shell pm uninstall -k zeljus.com.datetime
adb install -r $PROJECT/DateTime.apk

adb shell am start -n zeljus.com.datetime/zeljus.com.datetime.MainActivity
