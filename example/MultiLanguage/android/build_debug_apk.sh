...
PROJECT=/usr/local/pandroid/example/MultiLanguage
...
$PANDROID/pandroid R MultiLanguage zeljus.com.multilanguage $PROJECT/android/gen/zeljus/com/multilanguage/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/MultiLanguage.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/MultiLanguage.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/MultiLanguage.apk


adb unistall zeljus.com.multilanguage
adb install -r $PROJECT/MultiLanguage.apk

adb shell am start -n zeljus.com.multilanguage/zeljus.com.multilanguage.MainActivity
