...
PROJECT=/usr/local/pandroid/example/Demo3DCube
...
$PANDROID/pandroid R Demo3DCube zeljus.com.demo3dcube $PROJECT/android/gen/zeljus/com/demo3dcube/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/Demo3DCube.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/Demo3DCube.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/Demo3DCube.apk


#adb shell pm uninstall -k zeljus.com.demo3dcube
adb install -r $PROJECT/Demo3DCube.apk

adb shell am start -n zeljus.com.demo3dcube/zeljus.com.demo3dcube.MainActivity
