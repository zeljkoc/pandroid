...
PROJECT=/usr/local/pandroid/example/ReadGPS
...
$PANDROID/pandroid R ReadGPS zeljus.com.readgps $PROJECT/android/gen/zeljus/com/readgps/R.java $PROJECT/Rjava.pas
...
$TYPHON/fpc/fpc64/bin/x86_64-linux/ppcjvm @$TYPHON/fpcsrc/rtl/android/jvm/rtl.cfg -Ur -Tandroid -Pjvm -Ur -Xs -O2 -n -Fi$TYPHON/fpcsrc/rtl/inc -Fi$TYPHON/fpcsrc/rtl/jvm -Fi$TYPHON/fpcsrc/rtl/java -FE. -Fi$TYPHON/fpcsrc/rtl/android/jvm -Fu$PANDROID/units -FUbin/classes -djvm -dRELEASE $PROJECT/ReadGPS.lpr

#$PANDROID/compiler/ppcjvm -n -Tandroid -Fu$PANDROID/units/typhon -Fu$PANDROID/units -FEbin/classes $PROJECT/ReadGPS.lpr

echo ANT DEBUG ==========================================
ant -verbose release

jarsigner -verify -verbose -certs $PROJECT/ReadGPS.apk


adb shell pm uninstall -k zeljus.com.readgps
adb install -r $PROJECT/ReadGPS.apk

adb shell am start -n zeljus.com.readgps/zeljus.com.readgps.MainActivity
